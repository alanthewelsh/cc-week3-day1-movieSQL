...
--SELECT name FROM people;
--SELECT name FROM people WHERE name = 'Alan McLarney';
...
--SELECT name FROM people;
--INSERT INTO movies (title, show_time) VALUES ('Guardians of the Galaxy 2 - Midnight Showing!', '00:00');
UPDATE movies SET show_time = '21.30' WHERE title = "Guardians of the Galaxy" AND show_time = '19.35';
SELECT title FROM movies;
SELECT show_time FROM movies;


-- DELETE FROM movies WHERE id IN (5, 10)